...
public class ElysiumRegistries {
    public static final ResourceKey<Registry<BlockProperties>> BLOCK_PROPERTIES = key("block/properties");
    ...
    public static void datapackRegistry(DataPackRegistryEvent.NewRegistry event) {
        event.dataPackRegistry(BLOCK_PROPERTIES, BlockProperties.CODEC);
